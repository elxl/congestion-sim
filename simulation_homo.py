...
levels = [300,600,900,1200,1800,2100,2400,2700,3300,3600]
for congestion_level in levels:
    logging.basicConfig(filename=f'log/level{congestion_level}_log.out',
                        filemode='w',
    ...
    net = Network(congestion_level,homo=True)
